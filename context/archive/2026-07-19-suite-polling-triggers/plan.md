...
- [x] 6.1 Follow-up note file exists (or `## Notes` in `change.md` populated with the checklist) — 1cdcc94

#### Manual

- [x] 6.2 Notes are accurate vs the shipped Files Trigger (event names, Depth-1, soft-fail) — 1cdcc94
