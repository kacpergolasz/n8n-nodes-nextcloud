...
# Nextcloud community node (complete integration)
...
1. **What is the minimum supported Nextcloud version (if any)?** — TBD by user (NFR notes "exact minimum version TBD if needed"). Block: no.
